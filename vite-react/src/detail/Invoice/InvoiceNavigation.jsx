...
function InvoiceNavigation({onBack, onToCreateOn }){
    return (
        <div className="detail-navigation p-3 bg-white border-bottom shadow-sm">
            <div className="d-flex flex-wrap gap-2 mb-4">
                ...
                <Dropdown as={ButtonGroup} size="sm">
                  ...
                  <Dropdown.Menu>
                    <Dropdown.Item onClick={() => onToCreateOn({number: "ВН0000000001", date: new Date().toLocaleString()})}>Видаткова накладна</Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
            </div>
