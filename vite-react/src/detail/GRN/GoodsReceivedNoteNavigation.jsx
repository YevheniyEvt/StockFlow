...
function GoodsReceivedNoteNavigation({ document, onBack, onToCreateOn, counterparts, organizations, contracts, warehouses, operationTypes }){
    return (
                  ...
                  <Col md={6}>
                     <Form.Group controlId="counterparty">
                        ...
                        <Form.Select aria-label="Контрагент" size="sm">
                            <option>Виберіть вид операції...</option>
                            {operationTypes.map((operationType) => (
                                <option key={operationType.id}
                                        value={operationType.id}
                                        selected={operationType.id === document.operation_type_id}
                                >
                                    {operationType.name}
                                </option>
                            ))}
